    ...
    <div className="card-pf card-pf-utilization">
      ...
      <div className="row">
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 example-trend-container">
          {processData.dataAvailable ? <ServersAvailablePieChart data={processData.availableServers} config={chartConfig[serversAvailableConfig]} />
            : <EmptyChart />}
        </div>
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 example-trend-container">
          {processData.dataAvailable ? <ServersHealthPieChart data={processData.serversHealth} config={chartConfig[serversHealthConfig]} /> : <EmptyChart />}
        </div>
      </div>
    </div>
  );
